...
BEGIN
    INSERT INTO PERSONNE (NUM_PERSO, NOM, PRENOM,CONTACT,DATE_NAISSANCE) VALUES (:NEW.NUM_PERSO,:NEW.NOM,:NEW.PRENOM,:NEW.CONTACT,:NEW.DATE_NAISSANCE);
...
BEGIN
    INSERT INTO PERSONNE (NUM_PERSO, NOM, PRENOM,CONTACT,DATE_NAISSANCE) VALUES (:NEW.NUM_PERSO,:NEW.NOM,:NEW.PRENOM,:NEW.CONTACT,:NEW.DATE_NAISSANCE);
    INSERT INTO PERSONNEL (NUM_PERSONNEL, FONCTION, DATE_ANCIENNETE) VALUES (:NEW.NUM_PERSO,:NEW.FONCTION,:NEW.DATE_ANCIENNETE);
