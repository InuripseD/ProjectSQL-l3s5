...
CREATE VIEW ALL_DONNEURS AS 
	SELECT NUM_PERSO, NOM, PRENOM, CONTACT, AGE, EMAIL
		FROM PERSONNE
		JOIN DONNEUR ON NUM_DONNEUR = NUM_PERSO;

CREATE VIEW ALL_PATIENTS AS 
	SELECT NUM_PERSO, NOM, PRENOM, CONTACT, AGE, GROUPE_SANG
		FROM PERSONNE
		JOIN PATIENT ON NUM_PATIENT = NUM_PERSO;
    
CREATE VIEW ALL_PERSONNELS AS 
	SELECT NUM_PERSO, NOM, PRENOM, CONTACT, AGE, FONCTION, DATE_ANCIENNETE
		FROM PERSONNE
...
BEGIN
     INSERT INTO PERSONNE (NUM_PERSO, NOM, PRENOM,CONTACT,AGE) VALUES (:NEW.NUM_PERSO,:NEW.NOM,:NEW.PRENOM,:NEW.CONTACT,:NEW.AGE);
     INSERT INTO DONNEUR (NUM_DONNEUR, EMAIL) VALUES (:NEW.NUM_PERSO,:NEW.EMAIL);
END Insert_donneur;
/
...
BEGIN
     INSERT INTO PERSONNE (NUM_PERSO, NOM, PRENOM,CONTACT,AGE) VALUES (:NEW.NUM_PERSO,:NEW.NOM,:NEW.PRENOM,:NEW.CONTACT,:NEW.AGE);
     INSERT INTO PATIENT (NUM_PATIENT, GROUPE_SANG) VALUES (:NEW.NUM_PERSO,:NEW.GROUPE_SANG);
END Insert_patient;
/
...
BEGIN
     INSERT INTO PERSONNE (NUM_PERSO, NOM, PRENOM,CONTACT,AGE) VALUES (:NEW.NUM_PERSO,:NEW.NOM,:NEW.PRENOM,:NEW.CONTACT,:NEW.AGE);
     INSERT INTO PATIENT (NUM_PATIENT, FONCTION, DATE_ANCIENNETE) VALUES (:NEW.NUM_PERSO,:NEW.FONCTION,:NEW.DATE_ANCIENNETE);
END Insert_patient;
/
